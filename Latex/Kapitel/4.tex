...
\begin{figure}[h!]
	...
	\vspace{10pt} 
	\caption[Visualisierung der 'Accuracy' und 'Cross\_entropy' über die einzelnen Trainingsschritte]{Visualisierung der Accuracy und Cross Entropy über die einzelnen Trainingsschritte}
	\label{fig:skalare}
\end{figure}
